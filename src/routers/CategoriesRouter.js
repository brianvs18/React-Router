import { Redirect, Route, Switch, NavLink, useRouteMatch, Link } from 'react-router-dom';
...
export default function CategoriesRouter() {
    ...
    return (
        <div>
            <ul>
                <li>
                    <NavLink exact to={`${url}`} activeClassName="subactive">All</NavLink>
                </li>
                <li>
                    <NavLink to={`${url}/terror`} activeClassName="subactive">Terror</NavLink>
                </li>
                <li>
                    <NavLink to={`${url}/action`} activeClassName="subactive">Action</NavLink>
                </li>
                <li>
                    <NavLink to={`${url}/anime`} activeClassName="subactive">Anime</NavLink>
                </li>
            </ul>
            <Switch>
